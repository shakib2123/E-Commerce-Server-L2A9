  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
      ...
      <div style="padding: 20px; background-color: #f9f9f9; border-radius: 5px;">
        ...
        <p style="color: #555; font-size: 16px; line-height: 1.5;">
          This link will expire in 20 minutes for your security.
        </p>
      </div>
      <div style="margin-top: 30px; text-align: center; color: #777;">
        <p style="font-size: 14px;">&copy; ${new Date().getFullYear()} ClickMart. All rights reserved.</p>
      </div>
    </div>
  `;

  await transporter.sendMail({
    from: '"ClickMart" <mshakibalhasan21@gmail.com>', // sender address
